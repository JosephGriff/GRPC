...
@javax.annotation.Generated(
    ...
    comments = "Source: PasswordServ.proto")
public final class PasswordServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ie.gmit.ds.PasswordHashRequest,
      ie.gmit.ds.PasswordHashResponse> getHashMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hash",
      requestType = ie.gmit.ds.PasswordHashRequest.class,
      responseType = ie.gmit.ds.PasswordHashResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ie.gmit.ds.PasswordHashRequest,
      ie.gmit.ds.PasswordHashResponse> getHashMethod() {
    io.grpc.MethodDescriptor<ie.gmit.ds.PasswordHashRequest, ie.gmit.ds.PasswordHashResponse> getHashMethod;
      ...
      synchronized (PasswordServiceGrpc.class) {
        if ((getHashMethod = PasswordServiceGrpc.getHashMethod) == null) {
          PasswordServiceGrpc.getHashMethod = getHashMethod =
              io.grpc.MethodDescriptor.<ie.gmit.ds.PasswordHashRequest, ie.gmit.ds.PasswordHashResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hash"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ie.gmit.ds.PasswordHashRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ie.gmit.ds.PasswordHashResponse.getDefaultInstance()))
  ...
  public static io.grpc.MethodDescriptor<ie.gmit.ds.PasswordValidateRequest,
      com.google.protobuf.BoolValue> getValidateMethod() {
    io.grpc.MethodDescriptor<ie.gmit.ds.PasswordValidateRequest, com.google.protobuf.BoolValue> getValidateMethod;
    if ((getValidateMethod = PasswordServiceGrpc.getValidateMethod) == null) {
      synchronized (PasswordServiceGrpc.class) {
        if ((getValidateMethod = PasswordServiceGrpc.getValidateMethod) == null) {
          PasswordServiceGrpc.getValidateMethod = getValidateMethod =
              io.grpc.MethodDescriptor.<ie.gmit.ds.PasswordValidateRequest, com.google.protobuf.BoolValue>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public static abstract class PasswordServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hash(ie.gmit.ds.PasswordHashRequest request,
        io.grpc.stub.StreamObserver<ie.gmit.ds.PasswordHashResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ie.gmit.ds.PasswordHashRequest,
                ie.gmit.ds.PasswordHashResponse>(
                  this, METHODID_HASH)))
          .addMethod(
            getValidateMethod(),
            asyncUnaryCall(
  ...
  public static final class PasswordServiceBlockingStub extends io.grpc.stub.AbstractStub<PasswordServiceBlockingStub> {
    ...
    /**
     */
    public ie.gmit.ds.PasswordHashResponse hash(ie.gmit.ds.PasswordHashRequest request) {
    ...
    /**
     */
    public com.google.protobuf.BoolValue validate(ie.gmit.ds.PasswordValidateRequest request) {
      return blockingUnaryCall(
  ...
  public static final class PasswordServiceFutureStub extends io.grpc.stub.AbstractStub<PasswordServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ie.gmit.ds.PasswordHashResponse> hash(
        ie.gmit.ds.PasswordHashRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HASH:
          serviceImpl.hash((ie.gmit.ds.PasswordHashRequest) request,
              (io.grpc.stub.StreamObserver<ie.gmit.ds.PasswordHashResponse>) responseObserver);
          break;
  ...
  private static abstract class PasswordServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ie.gmit.ds.PasswordServ.getDescriptor();
    }
